...
arm-none-eabi-ld build/ts.o build/t.o build/uart.o build/image.o build/vid.o build/font.o build/char12x16.o ../../MyOS/libs/libgcc.a -T t.ld -o build/t.elf

arm-none-eabi-objcopy -O binary build/t.elf build/t.bin

qemu-system-arm -s -M versatilepb -cpu arm926 -kernel build/t.bin -serial telnet:localhost:1111,server 
